...
CREATE TABLE IF NOT EXISTS course_enrollments (
                                                  ...
                                                  enrollment_status ENUM('ACTIVE', 'DROPPED', 'COMPLETED') NOT NULL DEFAULT 'ACTIVE',
...
CREATE TABLE IF NOT EXISTS assignments (
    ...
    submission_type ENUM('TEXT', 'FILE', 'LINK') NOT NULL DEFAULT 'TEXT',
    ...
    UNIQUE (module_id, assignment_order)
    );
...
CREATE TABLE IF NOT EXISTS quiz_submission_answers (
                                                       ...
                                                       short_answer_text LONGTEXT NULL,
    ...
    FOREIGN KEY (quiz_submission_id)
...
CREATE TABLE IF NOT EXISTS syllabus_uploads (
    ...
    input_type ENUM('TEXT', 'FILE') NOT NULL DEFAULT 'TEXT',
...
CREATE TABLE IF NOT EXISTS curriculum_drafts (
                                                 ...
                                                 course_id BIGINT NOT NULL,
                                                 syllabus_upload_id BIGINT NOT NULL,
                                                 teacher_id BIGINT NOT NULL,
    ...
    FOREIGN KEY (syllabus_upload_id)
    REFERENCES syllabus_uploads(id)
    ON DELETE CASCADE,
